...
#CTS = indice di colonna e/o riga del carattere del test
#questo classificatore si trova nel package LibLineaR


test_prediction <- function(linear_model,TS,YTS,CTS,c,n_char,dimension,type){
  #set.seed(123)
